function srtDisplay(data) {
   ...
   data.forEach((soura) => {
      ...
      bigDiv.classList.add("bg-white", "rounded-xl", "shadow-md", "px-3", "pb-10", "pt-2", "gap-y-10", "text-xl", "soura");
      titreDiv.classList.add("mb-3", "text-center", "font-semibold");
      ...
      bigDiv.append(titreDiv, versesDiv, placeDiv);
